...
@interface DDTableRowViewModel : DDSimpleViewModel
...
@property (nonatomic,copy) void (^onSelectedRowViewModelBlock)(NSIndexPath * indexPath,DDSimpleViewModel * viewModel);
